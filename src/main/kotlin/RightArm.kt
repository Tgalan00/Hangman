object RightArm : Picture() {        //Creem l'object RightArm que ve relacionada amb la classe mare Pictures

    fun printRightArm() {           //Printem el dibuix del penjat segons les vides que tingui l'usuari
