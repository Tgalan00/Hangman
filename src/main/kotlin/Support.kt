object Support : Picture() {        //Creem l'object Support que ve relacionada amb la classe mare Pictures

    fun printSupport() {           //Printem el dibuix del penjat segons les vides que tingui l'usuari
